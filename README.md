...
백엔드 시스템과 검색 기반 서비스를 개발합니다.<br>
현재 공개 저장소에서는 한국어 RAG 검색 서비스와 HR·급여 ERP를 다룹니다.

![Backend](https://img.shields.io/badge/Backend-181717?style=for-the-badge&logo=github&logoColor=white)
![Search Systems](https://img.shields.io/badge/Search_Systems-0284C7?style=for-the-badge&logo=elasticsearch&logoColor=white)
![RAG](https://img.shields.io/badge/RAG-4F46E5?style=for-the-badge&logo=ollama&logoColor=white)
![Business Automation](https://img.shields.io/badge/Business_Automation-0F766E?style=for-the-badge&logo=springboot&logoColor=white)
...
[![Korean README](https://img.shields.io/badge/README-한국어-03C75A?style=flat-square)](https://github.com/sunwoo8478)
...
| 분야 | 내용 |
| --- | --- |
| 검색 시스템 | 정확 일치 검색, 벡터 검색, 리랭킹, 출처 추적 |
| 백엔드 | API 설계, 도메인 모델링, 인증·인가, 데이터 처리 |
| 업무 시스템 | 급여 계산, 법정 공제, 근태 및 인사 업무 자동화 |
| 개발 품질 | 테스트, 지속적 통합, 명확한 설정과 실행 절차 |
...
[![Repo size](https://img.shields.io/github/repo-size/sunwoo8478/korean-chatbot?style=flat-square)](https://github.com/sunwoo8478/korean-chatbot)
[![Issues](https://img.shields.io/github/issues/sunwoo8478/korean-chatbot?style=flat-square)](https://github.com/sunwoo8478/korean-chatbot/issues)

한국어 공공데이터 표준을 검색하고 답변 근거를 확인할 수 있는 서비스입니다.

- 정확 일치 검색과 벡터 검색을 결합한 하이브리드 검색
- 검색 결과 리랭킹과 출처 기반 응답
...
[![Repo size](https://img.shields.io/github/repo-size/sunwoo8478/ERP?style=flat-square)](https://github.com/sunwoo8478/ERP)
[![Issues](https://img.shields.io/github/issues/sunwoo8478/ERP?style=flat-square)](https://github.com/sunwoo8478/ERP/issues)

직원, 근태, 급여 계산, 법정 공제, 명세서 업무를 연결한 HR·급여 시스템입니다.

- 급여 계산과 법정 공제 규칙 구현
- 관리자·임직원 포털과 리포트 흐름 통합
- 백엔드 테스트와 프론트엔드 빌드 자동 검증
...
- 기능을 구현하기 전에 데이터 흐름과 책임 범위를 먼저 정리합니다.
- 복잡한 업무 규칙은 이름이 드러나는 작은 단위로 나눕니다.
- README에 실행 방법과 설정 조건을 남기고 CI에서 기본 검증을 반복합니다.
- 검색 결과와 자동 생성된 답변은 근거를 확인할 수 있도록 구성합니다.
